...
export default function UserHeader({
  ...
  return (
    <div
      className="card shadow-lg mb-4 border-0 overflow-hidden"
      style={{
        background:
    ...
    >
      ...
      <div
        style={{
          ...
          height: "300px",
          background:
            "radial-gradient(circle, rgba(147, 197, 253, 0.3) 0%, rgba(196, 181, 253, 0.2) 100%)",
          borderRadius: "50%",
          filter: "blur(60px)",
        ...
        <div className="row align-items-center g-4">
            ...
            <Box sx={{ position: "relative", display: "inline-block" }}>
              ...
              <Badge
                ...
                badgeContent={
                  ...
                  >
                    {isBlocked ? (
                      <BlockIcon sx={{ fontSize: 14, color: "white" }} />
                    ) : (
          ...
          <div className="col-12 col-lg-auto">
            <div className="d-flex flex-column gap-2 align-items-stretch">
              ...
              <Tooltip title="Show Barcode" arrow placement="left">
                <IconButton
